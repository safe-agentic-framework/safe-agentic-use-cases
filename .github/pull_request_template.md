...
<!-- List key files changed (registry, use-case page, root index) -->

## Author Confirmation

- [ ] I completed all items in `CONTRIBUTING.md` under `PR checklist (source of truth)`.
- [ ] I requested DSO/maintainer review.
